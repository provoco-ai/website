export function Logo(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <div className="flex items-center justify-center gap-4">
      <svg viewBox="0 0 315.424 315.424" {...props}>
        <path
          d="M311.929,222.266l-96.119-67.342c-1.413-0.99-2.783-1.513-4.307-1.513c-3.307,0-6.471,2.512-6.471,7.313v41.05H19.886
        ...
        />
        <path
          d="M104.073,162.136L104.073,162.136c2.082,0,4.137-0.958,5.371-2.63c0.939-1.271,1.588-2.891,1.588-4.683v-41.05h184.476
      ...
      <h1 className="font-display text-2xl font-medium tracking-tight text-slate-900 sm:text-4xl">
        Provoco
      </h1>
    </div>
  );
